 ...
 * `* More than 1 bean to inject found(it can happen when you created interface f.e. UserService and implemented it by SystemUserService and ExternalUserService,
